            ...
            <div class="grid w-full min-h-screen place-items-center">
                <div class="w-full">
                    ...
                    <div class="hero-content text-center border-2 rounded-xl border-gray-400 p-[40px]
                                w-[70%] h-[35rem] mx-auto bg-white shadow-lg ">
                        <div class="max-w-md mx-auto">

                            <h1 class="text-5xl font-bold text-[#1882FF] my-3">How to Play ?</h1>
                            <img :src="`${description[counter].img}`" alt="how-to-play" class="w-[70%] mx-auto my-6">
                            <p class="text-black font-semibold	">Connecting a word</p>
                            <p class="py-2 mb-8 text-gray-500">
                                {{ description[counter].content }}
                            </p>
                        </div>
                    </div>
                    <div class="gap-4 grid grid-cols-2 max-w-[40%] mx-auto mt-9">
