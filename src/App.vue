  ...
  >
    <section class="w-[700px]" v-show="counter==0">
      ...
      <div class="border border-gray-200 shadow-lg">
        ...
        <div class="flex justify-around py-3 border-b w-full">
          <div class="flex flex-col items-center w-1/3">
            <p class="text-2xl">Score</p>
            <p class="text-5xl">{{ score }}</p>
          </div>
          <div class="flex flex-col items-center w-1/3">
            <p class="text-2xl">Total Time</p>
            <p class="text-5xl">{{ totalTime }}</p>
          </div>
          <div class="flex flex-col items-center w-1/3">
            <p class="text-2xl">Word Count</p>
            <p class="text-5xl">{{ wordCount }}</p>
          </div>
        </div>
        <div class="py-10 flex justify-center gap-8">
          <button
            class="w-1/4 flex justify-center gap-2 bg-[#1882FF] py-1.5 text-white fill-white rounded-md font-bold"
            @click="playAgain()"          
            >
            <svg
              class="w-6"
          ...
          <button class="w-1/4 font-bold border-2 border-black rounded-md">
            See your stats
          </button>
        </div>
      </div>
